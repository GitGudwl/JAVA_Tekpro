public class Restaurant {
    ...
    public void tampilSalahsatu(int id){
        System.out.println(foods[id].getNama_makanan()+"("+foods[id].getStock()+")"+"\tRp."+foods[id].getHarga_makanan());
    }

    public void tampilmakanan(int id){
        System.out.println((id+1)+"."+foods[id].getNama_makanan());
    }
